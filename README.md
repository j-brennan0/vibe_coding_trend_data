...
activity, PyPI package downloads, Google Trends search interest), feeding a
Power BI dashboard.
...
If PyPI or Trends steps warn or fail on first run, check the log output -
...
- `PYPI_PACKAGES` - pip package names to pull weekly download totals for
